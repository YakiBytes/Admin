        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/tables/form.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/tables/supplier.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Supplier</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/tables/kalkulator.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kalkulator</p>
                </a>
              </li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Informasi mengenai kalkulator bibit.</h3>
              </div>
              ...
              <div class="card-body">
                <table id="myTabelUtama" class="table table-bordered table-hover table-striped">
                  ...
                  <tbody id="myTable">
                    <tr>
                      <th>1</th>
                      <th>asdfghjkl@email.com</th>
                      <th>oohsehun</th>
                      <th><a class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i>Update</a>
                      <a class="btn btn-info btn-sm"><i class="fas fa-trash"></i>Delete</a></th>
                    </tr>
                    <tr>
                      <th>2</th>
                      <th>qwertyui@email.com</th>
                      <th>nobody1</th>
                      <th><a class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i>Update</a>
                      <a class="btn btn-info btn-sm"><i class="fas fa-trash"></i>Delete</a></th>
                    </tr>
