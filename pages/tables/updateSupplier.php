              ...
              <div class="container mt-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select mt-3" id="jenis" name="jenis">
                      <option value="Benih" <?php aksingeselect($row["jenis"], "Benih"); ?> >01 Benih</option>
                      <option value="Bibit"  <?php aksingeselect($row["jenis"], "Bibit"); ?>>02 Bibit</option>
                      <option value="Benih dan Bibit"  <?php aksingeselect($row["jenis"], "Benih dan Bibit"); ?>>03 Benih dan Bibit</option>
                    </select>   
                  </div>
                  <div class="mb-3">
                    <label for="supplier">Nama Supplier:</label>
                    <input type="text" class="form-control" id="supplier" placeholder="masukan nama anda" name="supplier" value="<?php echo $row["supplier"]; ?>">
                  </div>
                  <div class="mb-3 mt-3">
                    <label for="alamat">Alamat</label>
                    <input type="text" class="form-control" id="alamat" placeholder="masukan alamat anda" name="jenis" value="<?php echo $row["jenis"]; ?>">
                  </div>
                  <div class="mb-3 mt-3">
                    <label for="kontak">Kontak</label>
                    <input type="text" class="form-control" id="kontak" placeholder="masukan kontak anda" name="kontak" value="<?php echo $row["kontak"]; ?>">
                  </div>  
                  <input type="hidden" name="id" value="<?php echo $row["id"]; ?>">
                  <button type="submit" class="btn btn-primary">Simpan!</button>
                  <a href="supplier.php" class="btn btn-primary">Kembali ke halaman daftar suppliers</a>
                </form>
              </div>
              </div>
              <!-- /.card-body -->
